...
<body>
	<div class="bg">	
		<a href="createuser.php"><button class="create"><i class="fa fa-plus" aria-hidden="true" style="color: darkgreen;"></i> | Add User</button>
		<!-- PHP CODE BLOCK -->
		...
		<?php
			...
			foreach ($users as $users) {
				...
				echo "<td>{$users['usertype']}</td>";
   				echo "<td><a href='#'><i class='fa fa-pencil-square fa-lg' aria-hidden='true' style = 'color: green';></i><a href='deleteuser.php'><i class='fa fa-trash fa-lg' aria-hidden='true' style = 'color: green';></i></td>";
    			echo "</tr>";
			}
		?>
		<!-- END OF PHP CODE BLOCK -->

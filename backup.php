		...
		<?php
			...
			foreach ($users as $users) {
                ...
                <input type='text' name='user_id' value=''>
   				<a href='#'><i class='fa fa-pencil-square fa-lg' aria-hidden='true' style = 'color: green';></i><a href='deleteuser.php'><i class='fa fa-trash fa-lg' aria-hidden='true' style = 'color: green';></i></form>
   				</td>";
    			echo "</tr>";
			}
		?>
